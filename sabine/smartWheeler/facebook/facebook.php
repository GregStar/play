...
$C = new mysqlDB('localhost', 'wdd909', 'student', 'doebroessy');
...
<html>
    <head>
        ...
        <?php
            ...
            ?>
            <link rel="stylesheet" type="text/css" href="http://student.sae.at/~12128/facebook/css/<?php echo $style; ?>.css" media="screen" />
            ...
            <script type="text/javascript" src="skin/mobile/js/script.js"></script>
        ...
        <div id="wrapper">
            ...
            <div id="content">
                        ...
                        <ul>
                            <?php
                                ...
                                while($row = mysql_fetch_array($events)){
                                    ...
                                    echo '<li><article>';
                                    echo '<h3>'.utf8_encode($row['titel']).'</h3>';
                                    echo '<p>'.utf8_encode($row['short_text']).'</p>';
                           //         echo '<p>'.utf8_encode($row['long_text']).'</p>';
                ...
                <div class="container" id="contact"> 
                    ...
                    <form action="#contact" method="post" id="contact_form" class="text">
                        <ul>
                            <?php
