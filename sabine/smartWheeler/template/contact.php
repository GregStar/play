<div class="content_wrap"> 
	<div id="featured" class="contact container" > 
    
    	<ul class="ui-tabs-nav text">
            <li class="ui-tabs-nav-item ui-tabs-selected" id="nav-contact_div"><a href="#contact_div" class="button"><img src="images/image1-small.jpg" alt="" /><span>Anfrage</span></a></li>
            <li class="ui-tabs-nav-item" id="nav-daten_container"><a href="#daten_container" class="button"><img src="images/image2-small.jpg" alt="" /><span>Kontaktdaten</span></a></li>
            <li class="ui-tabs-nav-item" id="nav-anfahrt_container"><a href="#anfahrt_container" class="button"><img src="images/image3-small.jpg" alt="" /><span>Anfahrt</span></a></li>
        </ul>
     
        <a id="formular"></a>
        <div id="contact_div" class="container clear autoheight3">
            <form action="<?php echo $_SERVER['PHP_SELF'].'?page=contact'; ?>" method="post" id="contact_form">
        ...
        <div id="daten_container">
            <div id="zeiten" class="container autoheight1">
