...
if($('#slider').length>0){
	...
	$('#slider').after('<div class="nav-bar"><a href="" id="prev" title="Previous Feature">Previous</a><a href="" id="next" title="Next Feature">Next</a></div>');
	}
	
	$('#slider').after('<div id="slider-nav"></div>').cycle({
	fx:'scrollHorz',
	speed:300,
	timeout:0,
	prev:'#prev',
	...
	$('#slider-nav a, #next, #prev').click(function(){
	$('#slider').addClass('pause').cycle('pause');
	});
};
